    ...
    return (<div className="min-h-screen bg-background pb-20">
      <header className="sticky top-0 z-40 bg-card border-b border-border">
        <div className="max-w-md mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <AutoFitMarquee as="h1" text={result.productName} className="flex-1" textClassName="font-bold" fontSizeClasses={["text-xl", "text-lg", "text-base", "text-sm"]}/>
        </div>
      </header>

      <main className="max-w-md mx-auto px-4 py-6 space-y-6">
        {imageData && (<Card className="p-4">
        ...
        <Card className="p-6 space-y-4">
          <div>
            ...
            <input type="text" value={result.brand} onChange={(e) => {
          ...
          <div>
            ...
            <input type="text" value={result.productName} onChange={(e) => {
          ...
          <div>
            ...
            <input type="number" value={result.originalPrice} onChange={(e) => {
          ...
          <div>
            ...
            <input type="date" value={result.expiryDate || ""} onChange={(e) => {
        ...
        <Card className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            {([-5, -1, 1, 5] as const).map((pct) => (<Button key={pct} variant="outline" onClick={() => adjustPrice(pct)} className="h-12" disabled={isRegistering}>
        ...
        <Button onClick={handleRegister} disabled={isRegistering} className="w-full h-14 text-lg font-semibold rounded-xl">
          {isRegistering ? (<><Loader2 className="w-5 h-5 mr-2 animate-spin"/>등록 중...</>) : ("등록하기")}
        </Button>
      </main>
