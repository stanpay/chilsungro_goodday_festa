...
const OneTouchPayment = () => {
    ...
    return (<div className="min-h-screen bg-background pb-20">
      ...
      <main className="max-w-md mx-auto px-4 py-6">
        ...
        {!isLoggedIn && (<div className="text-center py-4 mb-4 text-muted-foreground bg-card rounded-xl border border-border">
            원터치 결제를 사용할 수 없습니다
          </div>)}
        ...
        <Card className="p-6 mb-6 rounded-xl border-border/50">
          ...
          {!isEnabled && (<Button onClick={() => handleToggle(true)} disabled={!isLoggedIn || isRegistering} className="w-full mt-4">
